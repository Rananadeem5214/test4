...
def banner():
    print("""   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By Rana Nadeem Rajput  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/Rananadeem5214 ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
class crack:
	...
	def main(self,fl):
		try:
			...
			self.ko+=1
			print("\1b[0;33m[\b[0;37mCrack\b[0;33m]\b[0;37m \b[0;32m[\b[0;37mOK : %s\b[0;32m] \b[0;33m[\b[0;37mCP \b[0;33m]\b[0;37m  "%(self.ko,len(self.fl),len(self.ada),len(self.cp)), end='');sys.stdout.flush()
		except:
			self.main(fl)
